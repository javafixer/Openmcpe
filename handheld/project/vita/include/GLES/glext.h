#ifndef __drvglext_h_
#define __drvglext_h_
...
/*#define GL_RGB10_A2_OES										0x8059*/
/*#define GL_RGBA4_OES											0x8056*/
/*#define GL_RGB10_OES											0x8052*/
/*#define GL_RGB5_A1_OES										0x8057*/
...
#define GL_BGRA_EXT                                             0x80E1	/* PRQA S 3614 */
#endif
...
GL_API_EXT void GL_APIENTRY glRenderbufferStorageOES (GLenum target, GLenum internalformat, GLsizei width, GLsizei height);
...
GL_API_EXT void GL_APIENTRY glFramebufferRenderbufferOES (GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer);
GL_API_EXT void GL_APIENTRY glFramebufferTexture2DOES (GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
GL_API_EXT void GL_APIENTRY glGetFramebufferAttachmentParameterivOES (GLenum target, GLenum attachment, GLenum pname, GLint* params);
GL_API_EXT void GL_APIENTRY glGenerateMipmapOES (GLenum target);
#endif
...
GL_API_EXT void GL_APIENTRY glGetBufferPointervOES (GLenum target, GLenum pname, GLvoid** params);
#endif
...
GL_API_EXT void GL_APIENTRY glMatrixIndexPointerOES (GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);
GL_API_EXT void GL_APIENTRY glWeightPointerOES (GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);
#endif
...
#ifdef GL_GLEXT_PROTOTYPES
GL_API_EXT void GL_APIENTRY glBindVertexArrayOES(GLuint array);
GL_API_EXT void GL_APIENTRY glDeleteVertexArraysOES(GLsizei n, const GLuint *arrays);
GL_API_EXT void GL_APIENTRY glGenVertexArraysOES(GLsizei n, GLuint *arrays);
GL_API_EXT GLboolean GL_APIENTRY glIsVertexArrayOES (GLuint array);
#endif
...
#ifdef GL_GLEXT_PROTOTYPES
GL_API_EXT void GL_APIENTRY glMultiDrawArraysEXT (GLenum, GLint *, GLsizei *, GLsizei);
GL_API_EXT void GL_APIENTRY glMultiDrawElementsEXT (GLenum, const GLsizei *, GLenum, const GLvoid* *, GLsizei);
#endif /* GL_GLEXT_PROTOTYPES */
...
#ifdef GL_GLEXT_PROTOTYPES
GL_API_EXT void GL_APIENTRY glClipPlanefIMG (GLenum, const GLfloat *);
GL_API_EXT void GL_APIENTRY glClipPlanexIMG (GLenum, const GLfixed *);
#endif
...
#ifdef GL_GLEXT_PROTOTYPES
GL_API_EXT void GL_APIENTRY glVertexAttrib4fARB(GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
GL_API_EXT void GL_APIENTRY glProgramEnvParameter4fARB(GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
GL_API_EXT void GL_APIENTRY glProgramEnvParameter4fvARB(GLenum target, GLuint index, const GLfloat *params);
GL_API_EXT void GL_APIENTRY glProgramLocalParameter4fARB(GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
GL_API_EXT void GL_APIENTRY glProgramLocalParameter4fvARB(GLenum target, GLuint index, const GLfloat *params);
GL_API_EXT void GL_APIENTRY glVertexAttrib4xIMG(GLuint index, GLfixed x, GLfixed y, GLfixed z, GLfixed w);
GL_API_EXT void GL_APIENTRY glProgramLocalParameter4xIMG(GLenum target, GLuint index, GLfixed x, GLfixed y, GLfixed z, GLfixed w);
GL_API_EXT void GL_APIENTRY glProgramLocalParameter4xvIMG(GLenum target, GLuint index, const GLfixed *params);
GL_API_EXT void GL_APIENTRY glProgramEnvParameter4xIMG(GLenum target, GLuint index, GLfixed x, GLfixed y, GLfixed z, GLfixed w);
GL_API_EXT void GL_APIENTRY glProgramEnvParameter4xvIMG(GLenum target, GLuint index, const GLfixed *params);
GL_API_EXT void GL_APIENTRY glVertexAttribPointerARB(GLuint index, GLsizei size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid *pointer);
GL_API_EXT void GL_APIENTRY glEnableVertexAttribArrayARB(GLuint index);
GL_API_EXT void GL_APIENTRY glDisableVertexAttribArrayARB(GLuint index);
GL_API_EXT void GL_APIENTRY glProgramStringARB(GLenum target, GLenum format, GLsizei len, const void *string);
GL_API_EXT void GL_APIENTRY glBindProgramARB(GLenum target, GLuint program);
GL_API_EXT void GL_APIENTRY glDeleteProgramsARB(GLsizei n, const GLuint *programs);
GL_API_EXT void GL_APIENTRY glGenProgramsARB(GLsizei n, GLuint *programs);
#endif
#endif
